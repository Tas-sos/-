...
Τα οποία μπορείτε να τα δώσετε στο πρόγραμμα Gephi ( με τρόπο τον οποίο θα σας δείξουμε σύντομα )  και να σας φτιάξει αμέσως και χωρίς κανένα κόπο την γραφική αναπαράσταση του γράφου όπως την βλέπετε εδώ : 
